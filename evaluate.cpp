...
#define S(mg, eg) make_score(mg, eg)
  ...
  // Bonus for distance of king from last rank //hier
  constexpr Score KingRaceBonus[RANK_NB] = {
    S(1949, 1934), S(454, 364), S(151, 158), S(75, 85),
    S(42, 49), S(0, 0)
  };
...
#undef S
  ...
  Score Evaluation<T>::king() const {
    ...
    //koning
    //hier
    int ourrank = rank_of(pos.square<KING>(Us));
    int dist = (Us == WHITE) ? RANK_7-ourrank  : ourrank-RANK_2;
    score += KingRaceBonus[std::min(dist - 1, 5)];
    //tot hier
